...
<section class="app-promo-section" id="download-app-banner"><div class="container"><div class="app-promo-inner"><div class="promo-content"><div class="promo-logo-badge"><div class="logo-icon" style="width:48px;height:48px;display:flex;align-items:center;justify-content:center">WC</div><span class="promo-brand">{{ $siteSettings['site_name'] ?? 'WebComics' }}</span></div><h2 class="promo-title">Đọc truyện mọi nơi trên thiết bị của bạn</h2><p class="promo-subtitle">Phiên bản web hiện là sản phẩm đang hoạt động. App Store/Google Play chưa được cấu hình nên t không dựng nút tải giả chỉ để nó trông bận rộn.</p></div></div></div></section>
@endsection
