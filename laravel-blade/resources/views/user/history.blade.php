...
<main class="page-container"><div class="container" style="padding-top:32px;padding-bottom:56px;">
    ...
    <div style="display:grid;gap:12px;">
        @forelse($histories as $item)
            ...
            <article style="display:flex;gap:14px;background:var(--card-bg);border:1px solid var(--border);border-radius:14px;padding:14px;align-items:center;">
                ...
                <a href="{{ route('chapters.show',[$item->comic->slug,$item->chapter->slug]) }}" class="btn-spotlight-read" style="text-decoration:none;white-space:nowrap;">Đọc tiếp</a>
            </article>
            @endif
        @empty
