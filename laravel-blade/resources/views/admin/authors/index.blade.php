      ...
      <table class="admin-table" style="min-width:780px">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="text-align:center"><div style="display:flex;gap:6px;justify-content:center"><a href="{{ route('admin.authors.edit',$author) }}" class="btn-admin btn-admin-ghost btn-sm">✏️ Sửa</a><button type="button" class="btn-admin btn-admin-danger btn-sm" onclick="confirmDelete('{{ route('admin.authors.destroy',$author) }}', @js($author->name))">🗑️ Xóa</button></div></td>
          </tr>
          @endforeach
        </tbody>
      </table>
