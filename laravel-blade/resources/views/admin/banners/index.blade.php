...
@section('content')
<div class="admin-page-header" style="display:flex;justify-content:space-between;gap:12px;align-items:center;flex-wrap:wrap"><div><h1 class="admin-page-title">🖼️ Quản lý Banner Hero Slider Trang Chủ</h1><p class="admin-page-sub">Upload/URL ảnh, thời gian hiệu lực, thứ tự, bật tắt và theo dõi lượt click thật.</p></div><button type="button" class="btn-admin btn-admin-primary" onclick="openBannerModal()">+ Thêm Banner</button></div>
